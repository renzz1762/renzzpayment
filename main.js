...
const CFG = {
   ...
   */
  MAINTENANCE_TEXT: "Mohon maaf untuk sekarang HC AI lagi mengalami masalah di API KEY untuk sementara kita tutup dulu yah nanti kalo udah UPGRADE API KEKEY bakal ada pemberitahuan dari DEVELOPER HC AI,TERIMAKASIH 🙏"
